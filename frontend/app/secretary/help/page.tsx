            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="text-center mb-12">
                    ...
                    <p className="text-lg text-gray-600 dark:text-gray-400">
                        Everything you need to manage presentations and impact activities
                    </p>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-6 mb-8">
                    ...
                    <FeatureCard
                        ...
                        title="Dashboard"
                        description="View your activity summary and statistics"
                    >
                        <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
                            <li className="flex items-start">
                                <span className="text-green-500 mr-2">•</span>
                                Check total presentations and impact activities
                            </li>
                            <li className="flex items-start">
                                <span className="text-green-500 mr-2">•</span>
                            ...
                            <li className="flex items-start">
                                <span className="text-green-500 mr-2">•</span>
                                Track your monthly performance metrics
                            </li>
                        </ul>
                    </FeatureCard>
                </div>
...
// Helper Components (same as admin)
