...
const QUESTIONS = [
    { keys: ["q1_mobile", "q1_tablet", "q1_laptop", "q1_other"], label: "Q1" },
    ...
    { keys: ["p2_setLimits", "p2_keepScrolling", "p2_notSure"], label: "Post-Q2" },
    { keys: ["p3_pauseCheck", "p3_justDownload"], label: "Post-Q3" },
    { keys: ["p4_doneSharing", "p4_mightStill", "p4_alreadySafe"], label: "Post-Q4" },
];
                                            ...
                                            <Input
                                                ...
                                                onChange={(e) =>
                                                    updateResponse(
                                                        ...
                                                        ["q1_mobile", "q1_tablet", "q1_laptop", "q1_other"]
                                                    )
                                                }
                                            ...
                                            <Input
                                                ...
                                                onChange={(e) =>
                                                    updateResponse(
                                                        key,
                                                        Number(e.target.value),
                                                        ["q2_less1", "q2_1to3", "q2_4to6", "q2_more6"]
                                                    )
                                                }
                                                className="bg-gray-700 border-gray-600 text-gray-100 mt-1"
                                            />
                                            ...
                                            <Input
                                                ...
                                                onChange={(e) =>
                                                    updateResponse(
                                                        key,
                                                        Number(e.target.value),
                                                        ["p2_setLimits", "p2_keepScrolling", "p2_notSure"]
                                                    )
                                                }
                                                className="bg-gray-700 border-gray-600 text-gray-100 mt-1"
                                            />
                                            ...
                                            <Input
                                                ...
                                                onChange={(e) =>
                                                    updateResponse(
                                                        key,
                                                        Number(e.target.value),
                                                        ["p4_doneSharing", "p4_mightStill", "p4_alreadySafe"]
                                                    )
                                                }
                                                className="bg-gray-700 border-gray-600 text-gray-100 mt-1"
                                            />
