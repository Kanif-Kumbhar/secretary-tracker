...
// // Set your project start date here
// const PROJECT_START_DATE = new Date("2025-08-01");

// export default function WeekCard() {
//   const today = new Date();

//   // 1. Calculate the difference in days between today and project start
//   const diffInDays = Math.floor(
//     (today.getTime() - PROJECT_START_DATE.getTime()) / (1000 * 60 * 60 * 24)
//   );

//   // 2. Calculate the current week number
//   const weekNumber = Math.floor(diffInDays / 7) + 1;

//   // 3. Calculate the month by adding the day difference to the start date
//   const currentMonthDate = new Date(PROJECT_START_DATE);
//   currentMonthDate.setDate(PROJECT_START_DATE.getDate() + diffInDays);

//   // 4. Get the month name (short format, e.g., "Sep")
